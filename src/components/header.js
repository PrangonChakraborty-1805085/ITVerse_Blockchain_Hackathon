...
export default function Header() {
    ...
    function connectContract() {
        try {
            ...
            if (ethereum) {
                ...
                let Contract = new ethers.Contract(Contracts.contractAddress, Contracts.abi, signer);
    ...
    const handleBuyAbx = async (e) => {
        e.preventDefault();
        const transaction = await contract.buyABX({value: ethers.utils.parseEther(ether.toString())});
    }
            ...
            <Box sx={style}>
                <div className="bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
                    ...
                    <div className="relative mb-4">
                        <label htmlFor="abx-amnt" className="leading-7 text-sm text-gray-600">
                            Enter ABX Amount
                        </label>
                        <input
                            type="number"
