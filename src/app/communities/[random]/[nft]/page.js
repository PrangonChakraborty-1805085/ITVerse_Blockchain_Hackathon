...
export default function NFT({ art }) {
    ...
    if(!art){
        art = {title: "Monalisa", description:"A duplicate copy", ipfsCID: "bafybeibcec2crelvvhq4tvz57ne7gwvhyrpgpth35x2t7y2cqe3h7wnc2q", price : 1};
    }
    useEffect(() => {
        ...
        < section class="text-gray-600 body-font overflow-hidden" >
            <div class="container px-5 py-24 mx-auto">
                <div class="lg:w-4/5 mx-auto flex flex-wrap">
                    <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={img}></img>
                    <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">{art.title}</h1>
